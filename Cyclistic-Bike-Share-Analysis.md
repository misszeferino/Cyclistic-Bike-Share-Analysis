Case Study n°1 - Cyclistic bike-share analysis
================
Lucy Zeferino
...
Professional Certificate. In this case study, we will perform data
...
#### Checking for errors, where started_hour commes after ended_hour
...
In this phase, we are going to aggregate our data, perform
...
#### Comparing the numbers of members and casual rider
...
-   Run ad campaigns at the beginning of spring and summer, where the
